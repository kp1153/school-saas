            ...
            {teachers.rows.map((teacher) => (
              <tr key={teacher.id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 text-sm">
                  <Link href={`/teachers/${teacher.id}`} className="text-indigo-600 hover:text-indigo-900 mr-3">
                    View
                  </Link>
                  <Link href={`/teachers/${teacher.id}/edit`} className="text-gray-600 hover:text-gray-900">
                    Edit
                  </Link>
                </td>
              </tr>
