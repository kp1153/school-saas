        ...
        {session ? (
          <div className="flex min-h-screen">
            ...
            <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-200 flex overflow-x-auto">
              <Link href="/dashboard" className="flex-1 min-w-[56px] flex flex-col items-center justify-center py-2 text-[10px] font-medium text-gray-500">
                📊<span>Home</span>
              </Link>
              <Link href="/students" className="flex-1 min-w-[56px] flex flex-col items-center justify-center py-2 text-[10px] font-medium text-gray-500">
                🎓<span>Students</span>
              </Link>
              <Link href="/admissions" className="flex-1 min-w-[56px] flex flex-col items-center justify-center py-2 text-[10px] font-medium text-gray-500">
                📋<span>Admit</span>
              </Link>
              <Link href="/fees" className="flex-1 min-w-[56px] flex flex-col items-center justify-center py-2 text-[10px] font-medium text-gray-500">
                💰<span>Fees</span>
              </Link>
              <Link href="/attendance" className="flex-1 min-w-[56px] flex flex-col items-center justify-center py-2 text-[10px] font-medium text-gray-500">
                ✅<span>Attend</span>
              </Link>
              <Link href="/exams" className="flex-1 min-w-[56px] flex flex-col items-center justify-center py-2 text-[10px] font-medium text-gray-500">
                📝<span>Exams</span>
              </Link>
              <Link href="/notices" className="flex-1 min-w-[56px] flex flex-col items-center justify-center py-2 text-[10px] font-medium text-gray-500">
                📋<span>Notices</span>
              </Link>
              <Link href="/reports" className="flex-1 min-w-[56px] flex flex-col items-center justify-center py-2 text-[10px] font-medium text-gray-500">
                📊<span>Reports</span>
              </Link>
            </div>
            ...
            <nav className="bg-white border-b border-gray-200">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                  <div className="text-xl font-bold text-indigo-600">EduSaaS</div>
                  <Link href="/login" className="bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700 text-sm font-medium">
                    Login
                  </Link>
                </div>
              </div>
